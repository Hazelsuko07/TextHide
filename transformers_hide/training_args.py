...
class TrainingArguments:
    ...
    **which relate to the training loop itself**.
    ...
    dropout: float = field(default=0.4, metadata={"help": "Dropout ratio of the classifier."})
    small_cls: bool = field(default=False, metadata={"help": "Whether to apply a smaller classifier."})
